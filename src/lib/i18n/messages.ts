...
export const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'controls.fitProject': 'Fit to project',
    'menu.map': 'Map',
    ...
    'report.title': 'Tree report',
    'report.print': 'Print / save as PDF',
    'report.printHint': 'Use your browser’s print dialog to save the report as a PDF.',
    'report.contents': 'Report contents',
    'report.mapType': 'Map style',
    'report.inspections': 'Inspections',
    'report.photos': 'Photos',
    'report.photosGeneral': 'Tree photos',
    'report.photosInspection': 'Inspection {date}',
    'report.all': 'All',
    'report.none': 'None',
    'report.sectionLocation': 'Location',
    'report.sectionDetails': 'Tree details',
    'report.sectionInspections': 'Inspections',
    'report.sectionPhotos': 'Photos',
    'report.mapDetail': 'Detail',
    'report.mapContext': 'Surroundings',
    'report.coordinates': 'Coordinates (WGS84)',
    'report.inspector': 'Inspector',
    'report.noInspections': 'No inspections recorded.',
    'report.generated': 'Generated with TreeMap on {date}',
    ...
    'refimg.chooseHint': 'Pick a screenshot (e.g. satellite). It drops on the map under the pins.',
    'refimg.opacity': 'Opacity',
    'refimg.modeTransform': 'Move / resize',
    'refimg.modePoints': 'Fit by points',
    'refimg.dragHint': 'Drag {blue} to move, {green} to resize, {purple} to rotate.',
    'refimg.blue': 'blue',
    'refimg.green': 'green',
    'refimg.purple': 'purple',
    'refimg.save': 'Save overlay',
    'refimg.update': 'Update overlay',
    'refimg.updating': 'Updating…',
    'refimg.replace': 'Replace',
    'refimg.remove': 'Remove',
    'refimg.fitHint':
      'Click a feature on the {image}, then the same spot on the {map}. Repeat 2–3× across the area, then Fit.',
    'refimg.image': 'image',
    'refimg.map': 'map',
    'refimg.fit': 'Fit ({count})',
    'refimg.clearPoints': 'Clear points',

    'align.title': 'Align by points',
    'align.movedCount': '{moved}/{total} moved',
    'align.hint':
      'Click a pin you recognise, then drag its red handle to the correct spot. Do 3+ spread across the map, then Preview & Save.',
    'align.dragHandle': 'drag handle',
    'align.ignored': 'ignored',
    'align.fitSummary': 'Fit: {scale}% scale, {deg}° rot · median {median} m ({count} pts)',
    'align.needTwo': 'Move at least 2 pins to compute a fit.',
    'align.preview': 'Preview',
    'align.previewing': 'Previewing',
    'align.clear': 'Clear',
    'align.removePoint': 'Remove control point',

    'calib.title': 'Calibrate trees',
    'calib.pinCount': '{count} pins',
    'calib.eastWest': 'East ← → West',
    'calib.northSouth': 'North ↑ ↓ South',
    'calib.rotate': 'Rotate ↺ ↻',
    'calib.scale': 'Zoom (scale)',
    'calib.reset': 'Reset',
    'calib.decrease': 'Decrease {label}',
    'calib.increase': 'Increase {label}',
    'calib.hint':
  ...
  nl: {
    ...
    'controls.fitProject': 'Op project inzoomen',
    'menu.map': 'Kaart',
    ...
    'report.open': 'Rapport afdrukken',
    'report.title': 'Boomrapport',
    'report.print': 'Afdrukken / opslaan als PDF',
    'report.printHint': 'Gebruik het afdrukvenster van je browser om het rapport als PDF op te slaan.',
    'report.contents': 'Rapportinhoud',
    'report.mapType': 'Kaartstijl',
    'report.inspections': 'Inspecties',
    'report.photos': 'Foto’s',
    'report.photosGeneral': 'Boomfoto’s',
    'report.photosInspection': 'Inspectie {date}',
    'report.all': 'Alles',
    'report.none': 'Geen',
    'report.sectionLocation': 'Locatie',
    'report.sectionDetails': 'Boomgegevens',
    'report.sectionInspections': 'Inspecties',
    'report.sectionPhotos': 'Foto’s',
    'report.mapDetail': 'Detail',
    'report.mapContext': 'Omgeving',
    'report.coordinates': 'Coördinaten (WGS84)',
    'report.inspector': 'Inspecteur',
    'report.noInspections': 'Geen inspecties vastgelegd.',
    'report.generated': 'Gegenereerd met TreeMap op {date}',
    ...
    'refimg.chooseHint':
      'Kies een schermafbeelding (bijv. satelliet). Deze komt op de kaart onder de pinnen te liggen.',
    'refimg.opacity': 'Transparantie',
    'refimg.modeTransform': 'Verplaatsen / schalen',
    'refimg.modePoints': 'Passen met punten',
    'refimg.dragHint': 'Sleep {blue} om te verplaatsen, {green} om te schalen, {purple} om te draaien.',
    'refimg.blue': 'blauw',
    'refimg.green': 'groen',
    'refimg.purple': 'paars',
    'refimg.save': 'Laag opslaan',
    'refimg.update': 'Laag bijwerken',
    'refimg.updating': 'Bijwerken…',
    'refimg.replace': 'Vervangen',
    'refimg.remove': 'Verwijderen',
    'refimg.fitHint':
      'Klik op een herkenningspunt op de {image} en daarna op dezelfde plek op de {map}. Herhaal 2–3× verspreid over het gebied en kies dan Passen.',
    'refimg.image': 'afbeelding',
    'refimg.map': 'kaart',
    'refimg.fit': 'Passen ({count})',
    'refimg.clearPoints': 'Punten wissen',

    'align.title': 'Uitlijnen met punten',
    'align.movedCount': '{moved}/{total} versleept',
    'align.hint':
      'Klik op een pin die je herkent en sleep het rode handvat naar de juiste plek. Doe er 3+ verspreid over de kaart en kies dan Voorbeeld & Opslaan.',
    'align.dragHandle': 'versleep handvat',
    'align.ignored': 'genegeerd',
    'align.fitSummary': 'Passing: {scale}% schaal, {deg}° rotatie · mediaan {median} m ({count} punten)',
    'align.needTwo': 'Versleep minstens 2 pinnen om een passing te berekenen.',
    'align.preview': 'Voorbeeld',
    'align.previewing': 'Voorbeeld actief',
    'align.clear': 'Wissen',
    'align.removePoint': 'Controlepunt verwijderen',

    'calib.title': 'Bomen kalibreren',
    'calib.pinCount': '{count} pinnen',
    'calib.eastWest': 'Oost ← → West',
    'calib.northSouth': 'Noord ↑ ↓ Zuid',
    'calib.rotate': 'Draaien ↺ ↻',
    'calib.scale': 'Zoom (schaal)',
    'calib.reset': 'Reset',
    'calib.decrease': '{label} verlagen',
    'calib.increase': '{label} verhogen',
    'calib.hint':
      'Schuif tot de pinnen op de achtergrondkaart passen en sla op. Rotatie is om het middelpunt van de set. Omkeerbaar.',
  },
};
